...
# Multi-stage podcast script generation
SCRIPT_SOURCE_MAX_TOKENS = env.int("SCRIPT_SOURCE_MAX_TOKENS", default=3500)
SCRIPT_BRIEF_MAX_TOKENS = env.int("SCRIPT_BRIEF_MAX_TOKENS", default=1200)
SCRIPT_OUTLINE_MAX_TOKENS = env.int("SCRIPT_OUTLINE_MAX_TOKENS", default=1600)
SCRIPT_CHAPTER_MAX_TOKENS = env.int("SCRIPT_CHAPTER_MAX_TOKENS", default=2600)
SCRIPT_CRITIC_MAX_TOKENS = env.int("SCRIPT_CRITIC_MAX_TOKENS", default=900)
SCRIPT_COHERENCE_MAX_TOKENS = env.int("SCRIPT_COHERENCE_MAX_TOKENS", default=6000)
SCRIPT_CRITIC_THRESHOLD = env.int("SCRIPT_CRITIC_THRESHOLD", default=75)
SCRIPT_REWRITE_RETRIES = env.int("SCRIPT_REWRITE_RETRIES", default=1)
SCRIPT_POST_COHERENCE_CRITIC = env.bool("SCRIPT_POST_COHERENCE_CRITIC", default=False)
...
CHATTERBOX_VOICE_INTRO = env("CHATTERBOX_VOICE_INTRO", default="")
CHATTERBOX_VOICE_EXPERT = env("CHATTERBOX_VOICE_EXPERT", default="")
CHATTERBOX_VOICE_BEGINNER = env("CHATTERBOX_VOICE_BEGINNER", default="")
